...
# ax1.set_xlim(-15, 50)
#
# ax1.axvline(x=0, color='black', lw=3, c='maroon', label='0 Seconds')
...
#
# plt.legend(loc=3)
# plt.savefig('WT vs MMI for 3 eq (negative times, first 50 s)')

plt.scatter(x=eq.distances, y=eq.mmi, s=0.3)
plt.show()
print(np.min(eq.mmi))
